...
public class ObserverExample : MonoBehaviour
{
	...
	//public DelegateFunction onFunctionStart;       // Will hold references to methods with no parameters
	...
	//public IntDelegateFunction onFunctionStop;     // Will hold references to methods that accept an int parameter
	...
	void Update()
	{
		...
		if (Keyboard.current.zKey.wasPressedThisFrame) //this is how to get key down through the hardware without an input system (not usually what you should do, but sometimes necessary)
		{
